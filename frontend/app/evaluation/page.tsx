...
import { Users, Network, Award, LayoutDashboard } from 'lucide-react';
          ...
          <div className="p-6 space-y-6">
            ...
            <div className="bg-white rounded-lg shadow-md p-6">
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-start gap-3">
                  <div className="w-8 h-8 bg-gray-100 text-gray-400 rounded-full flex items-center justify-center font-bold flex-shrink-0">
                    4
                  </div>
                  <div>
                    <h3 className="font-medium text-gray-400">Create Evaluation Events</h3>
                    <p className="text-sm text-gray-500">
                      Launch performance evaluations based on your hierarchy (Coming Soon)
                    </p>
                  </div>
                </div>
              </div>
