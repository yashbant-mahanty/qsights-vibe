              ...
              <>
                ...
                <Card>
                  ...
                  <CardContent className="p-6 space-y-4">
                    <div className="p-4 bg-gradient-to-r from-blue-50 to-indigo-50 border-2 border-blue-300 rounded-lg mb-4">
                    ...
                    <div className="my-6 p-6 bg-gradient-to-br from-blue-50 to-purple-50 border-2 border-purple-200 rounded-xl">
                      ...
                      <div className="bg-white p-6 rounded-lg shadow-inner">
                        <div className="flex items-center justify-between max-w-4xl mx-auto">
                          ...
                          {/* Arrow 2 */}
                          <div className="flex flex-col items-center px-2">
                            <div className="text-xs font-medium text-purple-600 mb-1 whitespace-nowrap">SQL Queries →</div>
