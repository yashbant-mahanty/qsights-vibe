        ...
        <div className="bg-gradient-to-r from-blue-50 via-white to-purple-50 rounded-xl p-6 shadow-sm border border-gray-100">
          <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
            <div className="flex items-center gap-4">
              <button
                onClick={() => router.push("/activities")}
                className="flex items-center gap-2 px-3 py-2 text-gray-600 hover:text-gray-900 hover:bg-white rounded-lg transition-all shadow-sm border border-gray-200 hover:shadow-md hover:border-blue-300"
                      ...
                      const questionResponses = responses
                        .map((r: any) => {
                          ...
                          if (Array.isArray(r.answers) && r.answers.length > 0) {
                            ...
                            // Compare as strings to handle both numeric and UUID formats
                            const answer = r.answers.find((a: any) => 
                            ...
                            if (answer) {
                              ...
                              return answer.value_array || answer.value;
                            }
                          }
