...
<body>
    ...
    <div class="email-container">
        ...
        <div class="content">
            @if(!empty($headerText))
            <div style="color: #4a5568; font-size: 16px; margin-bottom: 25px; line-height: 1.6; padding: 15px; background-color: #f7fafc; border-radius: 8px;">
                {!! nl2br(e($headerText)) !!}
            </div>
            @endif
        ...
        <div class="footer">
            @if(!empty($footerText))
            <div style="margin: 0 0 20px 0; padding: 15px; background-color: #ffffff; border-radius: 8px; border-left: 3px solid #667eea;">
