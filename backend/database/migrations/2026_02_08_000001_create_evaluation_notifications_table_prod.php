...
return new class extends Migration
{
    /**
     * Run the migrations.
     * PRODUCTION VERSION - Uses bigint for IDs
     */
    public function up(): void
    {
        ...
        Schema::create('evaluation_notification_configs', function (Blueprint $table) {
            ...
            $table->uuid('program_id'); // programs.id is uuid
        ...
        Schema::create('evaluation_notification_logs', function (Blueprint $table) {
            $table->id(); // bigint auto-increment
            $table->uuid('evaluation_triggered_id')->nullable(); // evaluation_triggered.id is uuid
            $table->uuid('program_id'); // programs.id is uuid
            ...
            $table->unsignedBigInteger('recipient_id'); // users.id is bigint
        ...
        Schema::create('evaluation_bell_notifications', function (Blueprint $table) {
            $table->id(); // bigint auto-increment
            $table->unsignedBigInteger('user_id'); // users.id is bigint
            $table->uuid('evaluation_triggered_id')->nullable(); // evaluation_triggered.id is uuid
            $table->uuid('program_id'); // programs.id is uuid
        ...
        Schema::create('evaluation_reminder_schedules', function (Blueprint $table) {
            $table->id(); // bigint auto-increment
            $table->uuid('evaluation_triggered_id'); // evaluation_triggered.id is uuid
