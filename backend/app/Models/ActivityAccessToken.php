...
class ActivityAccessToken extends Model
{
    ...
    public static function validateToken($token)
    {
        ...
        // ALWAYS check if participant has already completed this activity
        // (not just when token is marked as used, as marking might have failed)
        // Note: The system uses 'submitted' status, not 'completed'
