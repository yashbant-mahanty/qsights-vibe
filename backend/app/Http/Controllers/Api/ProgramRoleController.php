...
class ProgramRoleController extends Controller
{
    ...
    public function storeSystemRole(Request $request)
    {
        ...
        $role = ProgramRole::create([
            ...
            'allowed_program_ids' => $request->allowed_program_ids ?? null, // null = All Programs
        ]);
    ...
    public function updateSystemRole(Request $request, $roleId)
    {
        ...
        if ($request->has('allowed_program_ids')) {
            // null = All Programs, array = Selected Programs
            $updateData['allowed_program_ids'] = $request->allowed_program_ids;
        }
    ...
    /**
     * Get all available services for system roles (unrestricted)
     */
    public function getAvailableServicesForSystemRoles(Request $request)
    {
        $user = $request->user();
        ...
        // All system-level permissions/services - System roles can have ANY service
        $services = [
            // Dashboard & Overview
            ['id' => 'dashboard', 'name' => 'Dashboard', 'category' => 'Overview', 'description' => 'View dashboard and statistics'],
